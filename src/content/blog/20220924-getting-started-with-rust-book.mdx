---
title: "Learning Rust: Getting Started with the Rust Book (Chapter One)"
description: "I want to use this blog to document my journey learning Rust, with the ambition of broadening my skills and professional opportunities."
date: "2022-09-24"
categories:
  - Systems Programming
  - Learning
...
The following content is my notes taken from **_The Rust Programming Language_**<Ref id="1" /> book ("the book"), so I want to first acknowledge authors _Steve Klabnik_ and _Carol Nichols_, with the contributing Rust developer community.
...
<BlogReferences>
  <BlogReference
    ...
    year="2019"
    month=""
    publication="Mozilla Corporation"
